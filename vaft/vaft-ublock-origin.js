...
(function() {
    ...
    function hookWorkerFetch() {
        console.log("%cVAFT:", "color: #9147ff", "Twitch adblocker is enabled (hookWorkerFetch).");
    ...
    async function processM3U8(url, textStr, realFetch) {
        ...
        if (haveAdTags) {
            ...
            if (streamInfo.CleanPlaylistCount >= 3 || !hasLiveSegments || slowPathReady) {
                ...
                console.log("%cVAFT:", "color: #9147ff", 'Finished blocking ads — stripped ' + streamInfo.NumStrippedAdSegments + ' ad segments, duration: ' + adBreakDurationSec + 's');
